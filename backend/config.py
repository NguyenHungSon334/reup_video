...
_DEFAULTS: dict[str, Any] = {
    ...
    "banner_gdrive_folder_id":   "1SGhndVCRCG2b2rcGjHrI2U1oZ_8K1LmT",
    # ── Media settings ────────────────────────────────────────────────────────
    "logo_path": "",
    "use_logo": True,
    "logo_scale": 150,
    ...
    "banner_path": "",
    "use_banner": True,
    "banner_scale_pct": 100.0,  # % of aspect-correct height; 100 = no distortion
    "music_path": "",
    "use_music": False,
    "music_folder": "",
...
_ENV_MAP = {
    ...
    "BANNER_GDRIVE_FOLDER_ID":  "banner_gdrive_folder_id",
